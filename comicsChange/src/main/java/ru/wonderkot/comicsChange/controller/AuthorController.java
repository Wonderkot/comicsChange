...
public class AuthorController {
	...
	@RequestMapping(value = "rest/updateAuthor", method = RequestMethod.PUT)
	public void updateAuthor(@RequestBody Author author) {
		daoImpl.updateAuthor(author);
	}

	@RequestMapping(value = "rest/findAuthor", method = RequestMethod.POST)
	public @ResponseBody ArrayList<Author> find(@RequestBody Author author) {
